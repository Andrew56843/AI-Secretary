...
const PRIVACY_SECTIONS = [
  ...
  },
  {
    ...
    text: [
      ...
      "Использование и передача Callsec информации, полученной из Google API, соответствует Google API Services User Data Policy, включая требования Limited Use.",
      "Данные Google Calendar используются только для предоставления пользователю функций календаря. Callsec не использует эти данные для рекламы и не использует и не передает их для обучения или улучшения обобщенных AI- и ML-моделей.",
      "Для понимания запроса и выполнения выбранного пользователем действия данные события могут обрабатываться через OpenAI API. Такая обработка выполняется только для предоставления функции Callsec, а добровольная передача API-данных для обучения моделей не включена.",
  ...
  return (
    <main className="legal-page">
      ...
      <article className="legal-document">
        ...
        <h1>{title}</h1>
        <p className="legal-updated">Последнее обновление: 18 августа 2026 года</p>
